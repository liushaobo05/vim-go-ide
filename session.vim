...
set runtimepath+=~/.vim/plugged/gotags/
...
set runtimepath+=~/.vim/plugged/vim-godef/
...
silent only
silent tabonly
cd ~/learn/go/leetcode/chapter01/section03
